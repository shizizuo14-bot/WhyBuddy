# SlideRule V2 Cross-Skill Runtime 118: AppBundle 075 runtime context normalizer to aigc
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-075-runtime-context-normalizer-to-aigc-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-075-runtime-context-normalizer-to-aigc-118.md`
