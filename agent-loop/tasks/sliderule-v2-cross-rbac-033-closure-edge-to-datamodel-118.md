# SlideRule V2 Cross-Skill Runtime 118: RBAC 033 closure graph edge to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-033-closure-edge-to-datamodel-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-033-closure-edge-to-datamodel-118.md`
