# SlideRule V2 Cross-Skill Runtime 118: RBAC 057 impact projection to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-057-impact-projection-to-workflow-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-057-impact-projection-to-workflow-118.md`
