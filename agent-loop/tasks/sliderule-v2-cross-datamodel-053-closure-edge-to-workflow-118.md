# SlideRule V2 Cross-Skill Runtime 118: DataModel 053 closure graph edge to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-053-closure-edge-to-workflow-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-053-closure-edge-to-workflow-118.md`
