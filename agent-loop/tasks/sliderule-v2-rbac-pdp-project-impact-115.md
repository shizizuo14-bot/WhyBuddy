...
- [ ] Project PDP, inheritance, SoD, fail-closed, and policy lifecycle nodes.
- [ ] Add cross-skill edges from RBAC changes to workflow/page/appbundle consumers.
- [ ] Add impact tests for deleting or changing finance role and a field policy.
