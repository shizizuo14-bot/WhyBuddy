# Backend Python 105: Web AIGC OCR vision audio real provider takeover

## Execution status
- Status: pending
- Goal: Move OCR, vision, speech, and audio provider boundaries to Python-owned runtime.
...
- `agent-loop/tasks/backend-python-web-aigc-media-real-provider-takeover-105.md`
...
- Previous 105 queue tasks 1-28 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Implement Python media provider config/readiness and execution boundary.
2. Delegate Node OCR/vision/audio routes to Python-first adapter.
3. Test missing key, fake transport, provider success, provider failure, and permission metadata.
