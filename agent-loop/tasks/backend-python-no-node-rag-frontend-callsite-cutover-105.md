# Backend Python No-Node API 105: Cut RAG frontend callsites from Node-owned endpoints to Python APIs.

## Execution status
- Status: pending
- Goal: Cut RAG frontend callsites from Node-owned endpoints to Python APIs.
...
- `agent-loop/tasks/backend-python-no-node-rag-frontend-callsite-cutover-105.md`
- Node side: `client/src/**, server/routes/rag.ts`
...
- Current task file: `agent-loop/tasks/backend-python-no-node-rag-frontend-callsite-cutover-105.md`
