# SlideRule V2 Cross-Skill Runtime 118: Page 054 fail-closed bridge to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-page-054-fail-closed-bridge-to-datamodel-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-054-fail-closed-bridge-to-datamodel-118.md`
