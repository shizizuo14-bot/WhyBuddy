# SlideRule V2 Cross-Skill Runtime 118: RBAC 028 audit trace evidence to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-028-audit-trace-to-datamodel-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-028-audit-trace-to-datamodel-118.md`
