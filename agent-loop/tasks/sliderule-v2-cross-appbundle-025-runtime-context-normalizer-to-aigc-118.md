# SlideRule V2 Cross-Skill Runtime 118: AppBundle 025 runtime context normalizer to aigc
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-025-runtime-context-normalizer-to-aigc-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes appbundle -> aigc linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-025-runtime-context-normalizer-to-aigc-118.md`
