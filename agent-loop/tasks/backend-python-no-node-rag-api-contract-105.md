# Backend Python No-Node API 105: Define Python-owned RAG API contract and response shapes.

## Execution status
- Status: pending
- Goal: Define Python-owned RAG API contract and response shapes.
...
- `agent-loop/tasks/backend-python-no-node-rag-api-contract-105.md`
- Node side: `server/routes/rag.ts, docs/**`
...
- Current task file: `agent-loop/tasks/backend-python-no-node-rag-api-contract-105.md`
