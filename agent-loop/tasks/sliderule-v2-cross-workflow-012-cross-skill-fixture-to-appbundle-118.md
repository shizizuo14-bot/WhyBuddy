# SlideRule V2 Cross-Skill Runtime 118: Workflow 012 cross-skill fixture to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-012-cross-skill-fixture-to-appbundle-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-012-cross-skill-fixture-to-appbundle-118.md`
