# SlideRule V2 Cross-Skill Runtime 118: Workflow 006 versioned snapshot link to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-006-versioned-snapshot-link-to-datamodel-118.md`
...
- [ ] Carry version, lifecycle, and snapshot refs across the source-to-target runtime boundary.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-006-versioned-snapshot-link-to-datamodel-118.md`
