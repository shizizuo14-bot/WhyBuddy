...
- [ ] Add runtime snapshot refs for pages, workflows, data models, RBAC policies, and AIGC capabilities.
- [ ] Validate snapshot entries match version pins.
- [ ] Project snapshot nodes in AppBundle diagrams.
