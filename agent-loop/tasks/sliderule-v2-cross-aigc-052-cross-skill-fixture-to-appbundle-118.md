# SlideRule V2 Cross-Skill Runtime 118: AIGC 052 cross-skill fixture to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-aigc-052-cross-skill-fixture-to-appbundle-118.md`
...
- [ ] Reuse or extend `evaluateAigcRuntimePolicy` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes aigc -> appbundle linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-aigc-052-cross-skill-fixture-to-appbundle-118.md`
