# Backend Python 105: Permission policy and role store takeover

## Execution status
- Status: pending
- Goal: Move permission role/policy store CRUD and versioning to Python-owned runtime.
...
- `agent-loop/tasks/backend-python-permission-policy-role-store-takeover-105.md`
...
- Previous 105 queue tasks 1-20 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Implement Python role/policy store with version semantics.
2. Delegate Node role/policy CRUD to Python-first adapter.
3. Test create/update/list/delete/version and permission-denied cases.
