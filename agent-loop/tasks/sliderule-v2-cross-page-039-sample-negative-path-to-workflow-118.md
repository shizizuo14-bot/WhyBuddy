# SlideRule V2 Cross-Skill Runtime 118: Page 039 negative runtime path to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-page-039-sample-negative-path-to-workflow-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-039-sample-negative-path-to-workflow-118.md`
