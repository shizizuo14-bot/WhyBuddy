# Backend Python No-Node API 105: Move delivery capability execution contracts to Python.

## Execution status
- Status: pending
- Goal: Move delivery capability execution contracts to Python.
...
- Node side: `server/sliderule/delivery-exec-map.ts, shared/blueprint/**`
- Python side: `slide-rule-python/routes/sliderule_full.py, slide-rule-python/services/**`
- Tests or smoke: `server/sliderule/__tests__/delivery-exec-map.test.ts`

## Evidence to read
- `agent-loop/tasks/backend-python-no-node-api-migration-status-105.md`
- `agent-loop/scripts/backend-python-api-cutover-no-node-105-queue.json`
- Current task file: `agent-loop/tasks/backend-python-no-node-sliderule-delivery-contract-105.md`
