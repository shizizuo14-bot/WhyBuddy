...
- [ ] Add or refine additive types for kernel role, runtime role, delegation, binding, version pin, publish gate, and policy decision evidence.
- [ ] Keep all changes source-compatible with existing Skill implementations.
- [ ] Add tests proving existing Skill definitions still typecheck through the shared contract.
