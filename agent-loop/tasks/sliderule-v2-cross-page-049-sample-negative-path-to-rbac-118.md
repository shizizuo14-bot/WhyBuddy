# SlideRule V2 Cross-Skill Runtime 118: Page 049 negative runtime path to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-page-049-sample-negative-path-to-rbac-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-049-sample-negative-path-to-rbac-118.md`
