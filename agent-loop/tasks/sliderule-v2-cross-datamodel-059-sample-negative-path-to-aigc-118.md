# SlideRule V2 Cross-Skill Runtime 118: DataModel 059 negative runtime path to aigc
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-059-sample-negative-path-to-aigc-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes datamodel -> aigc linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-059-sample-negative-path-to-aigc-118.md`
