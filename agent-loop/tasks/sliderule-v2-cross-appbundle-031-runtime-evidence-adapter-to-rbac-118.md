# SlideRule V2 Cross-Skill Runtime 118: AppBundle 031 runtime evidence adapter to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-031-runtime-evidence-adapter-to-rbac-118.md`
...
- [ ] Add a pure adapter that converts the source skill runtime output into a stable evidence object consumed by the target skill.
- [ ] Reuse or extend `evaluateAppBundleRuntimeClosure` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes appbundle -> rbac linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-031-runtime-evidence-adapter-to-rbac-118.md`
