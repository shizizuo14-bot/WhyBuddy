# SlideRule Python V5.2 Full Authority 105: Make Python driver execute multiple capability loops until stop condition.

## Execution status
- Status: pending
- Goal: Make Python driver execute multiple capability loops until stop condition.
...
- Current task file: `agent-loop/tasks/sliderule-python-v52-driver-execute-loop-105.md`
