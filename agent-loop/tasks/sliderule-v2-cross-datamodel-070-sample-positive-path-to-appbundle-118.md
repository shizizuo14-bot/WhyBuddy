# SlideRule V2 Cross-Skill Runtime 118: DataModel 070 positive runtime path to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-070-sample-positive-path-to-appbundle-118.md`
...
- [ ] Reuse or extend `traceFieldLineage` where it is the nearest existing runtime primitive.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-070-sample-positive-path-to-appbundle-118.md`
