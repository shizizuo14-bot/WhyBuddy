# SlideRule V2 Cross-Skill Runtime 118: Page 072 cross-skill fixture to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-page-072-cross-skill-fixture-to-appbundle-118.md`
...
- [ ] Reuse or extend `projectWorkflowTaskView` where it is the nearest existing runtime primitive.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-072-cross-skill-fixture-to-appbundle-118.md`
