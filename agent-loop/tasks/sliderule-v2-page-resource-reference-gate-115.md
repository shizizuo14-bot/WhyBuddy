...
- [ ] Represent workflow launch and route refs.
- [ ] Validate workflow refs against Workflow resolve surfaces where connected.
- [ ] Warn or error consistently for unresolved resources.
