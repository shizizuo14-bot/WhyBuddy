# SlideRule V2 Cross-Skill Runtime 118: AppBundle 002 cross-skill fixture to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-002-cross-skill-fixture-to-datamodel-118.md`
...
- [ ] Reuse or extend `createAppBundleRuntimeSnapshot` where it is the nearest existing runtime primitive.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-002-cross-skill-fixture-to-datamodel-118.md`
