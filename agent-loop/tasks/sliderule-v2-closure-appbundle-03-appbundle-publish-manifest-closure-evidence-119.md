# sliderule-v2-closure-appbundle-03-appbundle-publish-manifest-closure-evidence-119
...
## Objective
Expose publish closure evidence digest through the AppBundle publish manifest surface.
