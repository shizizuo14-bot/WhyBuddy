# Backend Python No-Node API 105: Reduce Node RAG route to a compatibility shell or remove it where safe.

## Execution status
- Status: pending
- Goal: Reduce Node RAG route to a compatibility shell or remove it where safe.
...
- `agent-loop/tasks/backend-python-no-node-rag-node-compat-thin-proxy-105.md`
- Node side: `server/routes/rag.ts, server/index.ts`
...
- Current task file: `agent-loop/tasks/backend-python-no-node-rag-node-compat-thin-proxy-105.md`
