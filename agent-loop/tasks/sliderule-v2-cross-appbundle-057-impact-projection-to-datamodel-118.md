# SlideRule V2 Cross-Skill Runtime 118: AppBundle 057 impact projection to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-057-impact-projection-to-datamodel-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-057-impact-projection-to-datamodel-118.md`
