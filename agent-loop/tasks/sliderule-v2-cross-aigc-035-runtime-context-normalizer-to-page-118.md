# SlideRule V2 Cross-Skill Runtime 118: AIGC 035 runtime context normalizer to page
...
- `agent-loop/tasks/sliderule-v2-cross-aigc-035-runtime-context-normalizer-to-page-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-aigc-035-runtime-context-normalizer-to-page-118.md`
