# SlideRule V2 Cross-Skill Runtime 118: Page 070 positive runtime path to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-page-070-sample-positive-path-to-datamodel-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-070-sample-positive-path-to-datamodel-118.md`
