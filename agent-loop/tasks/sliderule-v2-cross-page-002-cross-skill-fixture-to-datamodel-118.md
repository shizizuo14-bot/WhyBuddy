# SlideRule V2 Cross-Skill Runtime 118: Page 002 cross-skill fixture to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-page-002-cross-skill-fixture-to-datamodel-118.md`
...
- [ ] Reuse or extend `evaluatePageBindingExpressions` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes page -> datamodel linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-002-cross-skill-fixture-to-datamodel-118.md`
