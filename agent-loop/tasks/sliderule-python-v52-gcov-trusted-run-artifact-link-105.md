# SlideRule Python V5.2 Full Authority 105: Require capabilityRun to produced artifact linkage before a capability counts as covered.

## Execution status
- Status: pending
- Goal: Require capabilityRun to produced artifact linkage before a capability counts as covered.
...
- `slide-rule-python/services/slide_rule_coverage.py`
- `slide-rule-python/services/slide_rule_trust.py`
- `slide-rule-python/tests/test_sliderule_gcov_contract.py`
- `shared/blueprint/sliderule-coverage-gate.ts`
...
- Current task file: `agent-loop/tasks/sliderule-python-v52-gcov-trusted-run-artifact-link-105.md`
