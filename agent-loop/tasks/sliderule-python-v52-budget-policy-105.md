# SlideRule Python V5.2 Full Authority 105: Port maxTurns, maxRuns, maxRepeat, and maxTokens budget policy into Python.

## Execution status
- Status: pending
- Goal: Port maxTurns, maxRuns, maxRepeat, and maxTokens budget policy into Python.
...
- Current task file: `agent-loop/tasks/sliderule-python-v52-budget-policy-105.md`
