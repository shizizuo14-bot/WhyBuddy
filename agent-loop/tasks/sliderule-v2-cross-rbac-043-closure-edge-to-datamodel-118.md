# SlideRule V2 Cross-Skill Runtime 118: RBAC 043 closure graph edge to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-043-closure-edge-to-datamodel-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-043-closure-edge-to-datamodel-118.md`
