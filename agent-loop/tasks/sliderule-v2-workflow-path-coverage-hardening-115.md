...
- [ ] Add or strengthen tests for unreachable nodes, non-terminating loops, and missing default branches.
- [ ] Ensure graph traversal remains deterministic.
- [ ] Include one negative purchase workflow case for each failure family.
