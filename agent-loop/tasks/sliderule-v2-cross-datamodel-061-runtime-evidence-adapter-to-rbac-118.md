# SlideRule V2 Cross-Skill Runtime 118: DataModel 061 runtime evidence adapter to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-061-runtime-evidence-adapter-to-rbac-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes datamodel -> rbac linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-061-runtime-evidence-adapter-to-rbac-118.md`
