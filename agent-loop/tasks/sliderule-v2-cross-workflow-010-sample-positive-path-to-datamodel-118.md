# SlideRule V2 Cross-Skill Runtime 118: Workflow 010 positive runtime path to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-010-sample-positive-path-to-datamodel-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-010-sample-positive-path-to-datamodel-118.md`
