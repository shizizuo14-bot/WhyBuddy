# SlideRule V2 Cross-Skill Runtime 118: DataModel 012 cross-skill fixture to page
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-012-cross-skill-fixture-to-page-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes datamodel -> page linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-012-cross-skill-fixture-to-page-118.md`
