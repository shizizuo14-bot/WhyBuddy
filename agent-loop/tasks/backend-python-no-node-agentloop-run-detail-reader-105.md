# Backend Python No-Node API 105: Move AgentLoop run detail and log summary reading to Python.

## Execution status
- Status: pending
- Goal: Move AgentLoop run detail and log summary reading to Python.
...
- `agent-loop/tasks/backend-python-no-node-agentloop-run-detail-reader-105.md`
- Node side: `server/routes/agent-loop.ts, .agent-loop/runs/**`
- Python side: `slide-rule-python/services/**`
- Tests or smoke: `slide-rule-python/tests/test_agent_loop_runs.py`

## Evidence to read
- `agent-loop/tasks/backend-python-no-node-api-migration-status-105.md`
- `agent-loop/scripts/backend-python-api-cutover-no-node-105-queue.json`
- Current task file: `agent-loop/tasks/backend-python-no-node-agentloop-run-detail-reader-105.md`
