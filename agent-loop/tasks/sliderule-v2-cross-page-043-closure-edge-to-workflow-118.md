# SlideRule V2 Cross-Skill Runtime 118: Page 043 closure graph edge to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-page-043-closure-edge-to-workflow-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-043-closure-edge-to-workflow-118.md`
