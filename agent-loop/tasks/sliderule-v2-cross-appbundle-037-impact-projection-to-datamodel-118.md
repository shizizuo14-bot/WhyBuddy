# SlideRule V2 Cross-Skill Runtime 118: AppBundle 037 impact projection to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-037-impact-projection-to-datamodel-118.md`
...
- [ ] Add impact projection helpers so a source runtime change can report target skill impact evidence.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-037-impact-projection-to-datamodel-118.md`
