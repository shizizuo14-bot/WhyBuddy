# SlideRule V2 Cross-Skill Runtime 118: RBAC 016 versioned snapshot link to page
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-016-versioned-snapshot-link-to-page-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-016-versioned-snapshot-link-to-page-118.md`
