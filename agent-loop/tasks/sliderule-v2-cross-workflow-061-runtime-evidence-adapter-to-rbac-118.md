# SlideRule V2 Cross-Skill Runtime 118: Workflow 061 runtime evidence adapter to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-061-runtime-evidence-adapter-to-rbac-118.md`
...
- [ ] Reuse or extend `startWorkflowInstance` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes workflow -> rbac linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-061-runtime-evidence-adapter-to-rbac-118.md`
