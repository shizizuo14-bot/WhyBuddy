# SlideRule V2 Cross-Skill Runtime 118: AppBundle 013 closure graph edge to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-013-closure-edge-to-workflow-118.md`
...
- [ ] Project a typed cross-skill runtime edge into orchestrator or resolve/project surfaces with stable ids.
- [ ] Reuse or extend `evaluateAppBundleRuntimeClosure` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes appbundle -> workflow linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-013-closure-edge-to-workflow-118.md`
