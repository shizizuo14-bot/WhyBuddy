# SlideRule V2 Cross-Skill Runtime 118: AppBundle 022 cross-skill fixture to datamodel

## Execution status
- Status: PENDING
- Phase: 118-cross-skill-runtime
- Skill: appbundle
- Target skill: datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-022-cross-skill-fixture-to-datamodel-118.md`
...
- [ ] Add or extend purchase/leave fixtures so the source and target skills can be exercised together without external services.
- [ ] Reuse or extend `evaluateAppBundleRuntimeClosure` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes appbundle -> datamodel linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-022-cross-skill-fixture-to-datamodel-118.md`
