...
- [ ] Represent form field bindings as entity.field refs.
- [ ] Validate bindings against external DataModel surfaces.
- [ ] Remove or quarantine any local field-schema decision semantics.
