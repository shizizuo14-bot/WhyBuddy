# SlideRule V2 Hardening 115.30.05: Workflow timeout action model

## Execution status
- Status: PENDING
- Phase: 115.30-workflow
- Goal: Represent timeout policies and automatic actions without adding a real queue or timer runtime.
- Required gate: `sliderule-v2-workflow-timeout-action-model-115Gates`
...
- `agent-loop/tasks/sliderule-v2-workflow-timeout-action-model-115.md`
...
- [ ] Add timeout duration, escalation target, and auto action metadata.
- [ ] Validate timeout target nodes and escalation role refs.
- [ ] Project timeout edges in workflow diagrams.
