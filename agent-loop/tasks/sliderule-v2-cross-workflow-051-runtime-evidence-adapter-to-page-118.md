# SlideRule V2 Cross-Skill Runtime 118: Workflow 051 runtime evidence adapter to page
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-051-runtime-evidence-adapter-to-page-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-051-runtime-evidence-adapter-to-page-118.md`
