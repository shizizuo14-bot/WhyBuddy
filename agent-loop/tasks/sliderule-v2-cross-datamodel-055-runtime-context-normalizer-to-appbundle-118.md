# SlideRule V2 Cross-Skill Runtime 118: DataModel 055 runtime context normalizer to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-055-runtime-context-normalizer-to-appbundle-118.md`
...
- [ ] Normalize runtime context from mixed surfaces into one deterministic in-memory request shape.
- [ ] Reuse or extend `planDataModelMigration` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes datamodel -> appbundle linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-055-runtime-context-normalizer-to-appbundle-118.md`
