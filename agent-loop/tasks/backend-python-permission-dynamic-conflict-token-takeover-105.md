# Backend Python 105: Permission dynamic conflict token takeover

## Execution status
- Status: pending
- Goal: Move dynamic permissions, conflict detection, and permission tokens to Python runtime.
...
- `agent-loop/tasks/backend-python-permission-dynamic-conflict-token-takeover-105.md`
- `server/permission/**`
...
- Previous 105 queue tasks 1-21 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Implement Python dynamic grant/revoke/conflict/token service.
2. Wire Node permission routes to Python-first operations.
3. Test temporary grants, revoke, conflict detection, token issue/revoke.
