# SlideRule V2 Cross-Skill Runtime 118: AppBundle 020 positive runtime path to aigc
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-020-sample-positive-path-to-aigc-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-020-sample-positive-path-to-aigc-118.md`
