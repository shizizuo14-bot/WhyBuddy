# SlideRule V2 Cross-Skill Runtime 118: RBAC 061 runtime evidence adapter to page
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-061-runtime-evidence-adapter-to-page-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes rbac -> page linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-061-runtime-evidence-adapter-to-page-118.md`
