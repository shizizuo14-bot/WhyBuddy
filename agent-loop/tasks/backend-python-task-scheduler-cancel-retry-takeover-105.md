# Backend Python 105: Task scheduler cancel retry takeover

## Execution status
- Status: pending
- Goal: Move scheduler, cancel, retry, and replay decisions into Python-owned runtime.
...
- `agent-loop/tasks/backend-python-task-scheduler-cancel-retry-takeover-105.md`
...
- Previous 105 queue tasks 1-12 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Implement Python scheduler decision runtime for start/cancel/retry/replay.
2. Route Node scheduler operations through Python-first adapter.
3. Test cancel idempotency, retry limits, replay safety, and degraded Python response.
