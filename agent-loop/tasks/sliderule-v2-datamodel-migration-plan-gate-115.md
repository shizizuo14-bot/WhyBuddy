...
- [ ] Add migration plan metadata for add, rename, deprecate, remove, and type-change actions.
- [ ] Warn on high-risk migrations and error on destructive changes without a plan.
- [ ] Keep runtime-less: no database or actual migration executor.
