# Backend Python 105: Auth user repository takeover

## Execution status
- Status: pending
- Goal: Move user repository read/write/profile lookup semantics to Python-owned runtime.
...
- `agent-loop/tasks/backend-python-auth-user-repository-takeover-105.md`
...
- Previous 105 queue tasks 1-15 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Implement Python user repository adapter with register/find/update profile semantics.
2. Delegate Node auth user operations to Python-first adapter.
3. Test duplicate user, missing user, profile update, and storage failure.
