# SlideRule V2 Cross-Skill Runtime 118: AppBundle 054 fail-closed bridge to page
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-054-fail-closed-bridge-to-page-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-054-fail-closed-bridge-to-page-118.md`
