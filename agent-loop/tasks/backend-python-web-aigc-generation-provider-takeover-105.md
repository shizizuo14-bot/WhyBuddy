# Backend Python 105: Web AIGC PPT chart transaction provider takeover

## Execution status
- Status: pending
- Goal: Move AI PPT, dynamic chart, and transaction-flow production provider boundaries to Python.
...
- `agent-loop/tasks/backend-python-web-aigc-generation-provider-takeover-105.md`
...
- Previous 105 queue tasks 1-29 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Implement Python provider adapters for PPT/chart/transaction outputs.
2. Route Node adapters through Python-first runtime.
3. Test artifact provenance, provider degraded state, and billing/safety metadata.
