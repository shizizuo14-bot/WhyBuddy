...
- [ ] Error on visibility refs to missing components or missing PDP refs.
- [ ] Validate field-level visibility such as amount visible only to finance/admin.
- [ ] Project visibility edges in page diagrams.
