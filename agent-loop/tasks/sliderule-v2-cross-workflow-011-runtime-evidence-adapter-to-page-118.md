# SlideRule V2 Cross-Skill Runtime 118: Workflow 011 runtime evidence adapter to page
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-011-runtime-evidence-adapter-to-page-118.md`
...
- [ ] Reuse or extend `resolveWorkflowAssignees` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes workflow -> page linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-011-runtime-evidence-adapter-to-page-118.md`
