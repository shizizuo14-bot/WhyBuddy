# SlideRule V2 Cross-Skill Runtime 118: RBAC 022 cross-skill fixture to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-022-cross-skill-fixture-to-workflow-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes rbac -> workflow linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-022-cross-skill-fixture-to-workflow-118.md`
