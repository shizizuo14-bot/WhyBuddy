# SlideRule Python V5.2 Full Authority 105: Add full path pytest from user instruction to artifacts, GCOV, and await/done.

## Execution status
- Status: pending
- Goal: Add full path pytest from user instruction to artifacts, GCOV, and await/done.
...
- Current task file: `agent-loop/tasks/sliderule-python-v52-driver-fullpath-tests-105.md`
