...
- [ ] Keep existing role and permission surfaces stable.
- [ ] Add new surfaces for policy and field-rule refs without breaking existing consumers.
- [ ] Update orchestrator tests for workflow/page/appbundle references into RBAC.
