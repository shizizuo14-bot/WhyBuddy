# SlideRule V2 Cross-Skill Runtime 118: Page 041 runtime evidence adapter to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-page-041-runtime-evidence-adapter-to-rbac-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes page -> rbac linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-041-runtime-evidence-adapter-to-rbac-118.md`
