# SlideRule V2 Cross-Skill Runtime 118: Page 019 negative runtime path to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-page-019-sample-negative-path-to-workflow-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-019-sample-negative-path-to-workflow-118.md`
