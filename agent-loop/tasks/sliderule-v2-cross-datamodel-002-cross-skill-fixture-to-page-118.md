# SlideRule V2 Cross-Skill Runtime 118: DataModel 002 cross-skill fixture to page
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-002-cross-skill-fixture-to-page-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-002-cross-skill-fixture-to-page-118.md`
