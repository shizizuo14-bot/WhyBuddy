# Backend Python No-Node API 105: Move AgentLoop run history list reading to Python.

## Execution status
- Status: pending
- Goal: Move AgentLoop run history list reading to Python.
...
- `agent-loop/tasks/backend-python-no-node-agentloop-run-history-reader-105.md`
...
- Current task file: `agent-loop/tasks/backend-python-no-node-agentloop-run-history-reader-105.md`
