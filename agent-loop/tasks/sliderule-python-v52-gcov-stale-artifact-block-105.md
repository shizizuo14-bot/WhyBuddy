# SlideRule Python V5.2 Full Authority 105: Block stale artifacts from satisfying coverage or trusted committed checks.

## Execution status
- Status: pending
- Goal: Block stale artifacts from satisfying coverage or trusted committed checks.
...
- Current task file: `agent-loop/tasks/sliderule-python-v52-gcov-stale-artifact-block-105.md`
