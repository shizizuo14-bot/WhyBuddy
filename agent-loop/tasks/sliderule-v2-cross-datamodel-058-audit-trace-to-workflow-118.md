# SlideRule V2 Cross-Skill Runtime 118: DataModel 058 audit trace evidence to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-058-audit-trace-to-workflow-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-058-audit-trace-to-workflow-118.md`
