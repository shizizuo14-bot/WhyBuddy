# SlideRule V2 Cross-Skill Runtime 118: Workflow 065 runtime context normalizer to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-065-runtime-context-normalizer-to-rbac-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-065-runtime-context-normalizer-to-rbac-118.md`
