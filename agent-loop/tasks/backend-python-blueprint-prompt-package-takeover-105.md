# Backend Python 105: Blueprint prompt package takeover

## Execution status
- Status: pending
- Goal: Move prompt package validation, normalization, and package metadata generation into Python-owned runtime.
...
- `agent-loop/tasks/backend-python-blueprint-prompt-package-takeover-105.md`
- `server/routes/blueprint/**prompt**`
- `slide-rule-python/services/blueprint_prompt_package_runtime.py`
...
- Previous 105 queue tasks 1-4 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Implement Python package build/validate/normalize runtime.
2. Route Node package endpoints through Python-first adapter.
3. Test package metadata, redaction, model/provider fallback, and invalid package failures.
