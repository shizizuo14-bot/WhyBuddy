# Backend Python No-Node API 105: Move queue-outcomes reading and status projection to Python.

## Execution status
- Status: pending
- Goal: Move queue-outcomes reading and status projection to Python.
...
- `agent-loop/tasks/backend-python-no-node-agentloop-queue-outcomes-reader-105.md`
- Node side: `server/routes/agent-loop.ts, .agent-loop/queue-outcomes.json`
...
- Current task file: `agent-loop/tasks/backend-python-no-node-agentloop-queue-outcomes-reader-105.md`
