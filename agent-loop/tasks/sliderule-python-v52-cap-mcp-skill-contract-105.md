# SlideRule Python V5.2 Full Authority 105: Make mcp.call and skill.invoke explicit Python contracts instead of silent template text.

## Execution status
- Status: pending
- Goal: Make mcp.call and skill.invoke explicit Python contracts instead of silent template text.
...
- Current task file: `agent-loop/tasks/sliderule-python-v52-cap-mcp-skill-contract-105.md`
