# SlideRule V2 Cross-Skill Runtime 118: AIGC 033 closure graph edge to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-aigc-033-closure-edge-to-rbac-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-aigc-033-closure-edge-to-rbac-118.md`
