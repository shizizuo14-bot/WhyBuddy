# SlideRule V2 Cross-Skill Runtime 118: AppBundle 008 audit trace evidence to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-008-audit-trace-to-workflow-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-008-audit-trace-to-workflow-118.md`
