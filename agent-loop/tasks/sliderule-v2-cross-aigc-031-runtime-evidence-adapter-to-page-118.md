# SlideRule V2 Cross-Skill Runtime 118: AIGC 031 runtime evidence adapter to page
...
- `agent-loop/tasks/sliderule-v2-cross-aigc-031-runtime-evidence-adapter-to-page-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes aigc -> page linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-aigc-031-runtime-evidence-adapter-to-page-118.md`
