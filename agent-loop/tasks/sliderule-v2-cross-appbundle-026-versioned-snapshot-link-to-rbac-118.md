# SlideRule V2 Cross-Skill Runtime 118: AppBundle 026 versioned snapshot link to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-026-versioned-snapshot-link-to-rbac-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-026-versioned-snapshot-link-to-rbac-118.md`
