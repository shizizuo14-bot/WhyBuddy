# Backend Python No-Node API 105: Move RAG source evidence and citation payloads to Python.

## Execution status
- Status: pending
- Goal: Move RAG source evidence and citation payloads to Python.
...
- `agent-loop/tasks/backend-python-no-node-rag-source-evidence-contract-105.md`
- Node side: `server/routes/rag.ts, server/rag/**, client/src/**`
- Python side: `slide-rule-python/services/rag_service.py, slide-rule-python/routes/**`
- Tests or smoke: `slide-rule-python/tests/test_rag_service.py`

## Evidence to read
- `agent-loop/tasks/backend-python-no-node-api-migration-status-105.md`
- `agent-loop/scripts/backend-python-api-cutover-no-node-105-queue.json`
- Current task file: `agent-loop/tasks/backend-python-no-node-rag-source-evidence-contract-105.md`
