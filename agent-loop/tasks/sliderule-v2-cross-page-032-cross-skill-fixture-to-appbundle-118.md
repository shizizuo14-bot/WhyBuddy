# SlideRule V2 Cross-Skill Runtime 118: Page 032 cross-skill fixture to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-page-032-cross-skill-fixture-to-appbundle-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes page -> appbundle linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-032-cross-skill-fixture-to-appbundle-118.md`
