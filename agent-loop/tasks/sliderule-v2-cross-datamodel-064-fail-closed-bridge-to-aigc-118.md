# SlideRule V2 Cross-Skill Runtime 118: DataModel 064 fail-closed bridge to aigc
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-064-fail-closed-bridge-to-aigc-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-064-fail-closed-bridge-to-aigc-118.md`
