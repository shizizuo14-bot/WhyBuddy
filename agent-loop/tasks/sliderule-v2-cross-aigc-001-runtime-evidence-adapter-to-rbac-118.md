# SlideRule V2 Cross-Skill Runtime 118: AIGC 001 runtime evidence adapter to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-aigc-001-runtime-evidence-adapter-to-rbac-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes aigc -> rbac linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-aigc-001-runtime-evidence-adapter-to-rbac-118.md`
