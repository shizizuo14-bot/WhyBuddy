# Backend Python No-Node API 105: Reduce Node AgentLoop API to a thin compatibility shell over Python.

## Execution status
- Status: pending
- Goal: Reduce Node AgentLoop API to a thin compatibility shell over Python.
...
- `agent-loop/tasks/backend-python-no-node-agentloop-node-compat-thin-proxy-105.md`
- Node side: `server/routes/agent-loop.ts, server/index.ts`
- Python side: `slide-rule-python/routes/**`
- Tests or smoke: `server/routes/__tests__/agent-loop-python-proxy-105.test.ts`

## Evidence to read
- `agent-loop/tasks/backend-python-no-node-api-migration-status-105.md`
- `agent-loop/scripts/backend-python-api-cutover-no-node-105-queue.json`
- Current task file: `agent-loop/tasks/backend-python-no-node-agentloop-node-compat-thin-proxy-105.md`
