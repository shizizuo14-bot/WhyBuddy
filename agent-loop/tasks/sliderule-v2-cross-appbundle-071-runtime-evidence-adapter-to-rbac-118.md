# SlideRule V2 Cross-Skill Runtime 118: AppBundle 071 runtime evidence adapter to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-071-runtime-evidence-adapter-to-rbac-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-071-runtime-evidence-adapter-to-rbac-118.md`
