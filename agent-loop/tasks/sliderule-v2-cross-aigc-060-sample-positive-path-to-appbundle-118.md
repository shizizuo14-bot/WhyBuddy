# SlideRule V2 Cross-Skill Runtime 118: AIGC 060 positive runtime path to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-aigc-060-sample-positive-path-to-appbundle-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-aigc-060-sample-positive-path-to-appbundle-118.md`
