# Backend Python 105: Blueprint diagnostics takeover

## Execution status
- Status: pending
- Goal: Move Blueprint diagnostics, health, and explainability rollups to Python-owned runtime.
...
- `agent-loop/tasks/backend-python-blueprint-diagnostics-takeover-105.md`
- `server/routes/blueprint.ts`
- `server/routes/blueprint/**diagnostic**`
...
- Previous 105 queue tasks 1-6 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Add Python diagnostics rollup service using job/event/ledger signals.
2. Expose Node route as thin proxy to Python diagnostics.
3. Test missing Python, unhealthy Python, partial data, and healthy rollup.
