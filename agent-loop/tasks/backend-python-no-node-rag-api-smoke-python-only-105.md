# Backend Python No-Node API 105: Add API or browser smoke proving RAG uses Python backend.

## Execution status
- Status: pending
- Goal: Add API or browser smoke proving RAG uses Python backend.
...
- `agent-loop/tasks/backend-python-no-node-rag-api-smoke-python-only-105.md`
- Node side: `scripts/**, package.json, server/routes/rag.ts`
...
- Current task file: `agent-loop/tasks/backend-python-no-node-rag-api-smoke-python-only-105.md`
