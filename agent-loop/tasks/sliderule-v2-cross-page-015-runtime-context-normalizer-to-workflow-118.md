# SlideRule V2 Cross-Skill Runtime 118: Page 015 runtime context normalizer to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-page-015-runtime-context-normalizer-to-workflow-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-015-runtime-context-normalizer-to-workflow-118.md`
