...
- [ ] Project SSOT as the central host node.
- [ ] Include field lifecycle, relation, dataset, migration, and PDP delegation edges.
- [ ] Assert the mermaid output contains the important V2 nodes.
