# SlideRule V2 Cross-Skill Runtime 118: Workflow 063 closure graph edge to page
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-063-closure-edge-to-page-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-063-closure-edge-to-page-118.md`
