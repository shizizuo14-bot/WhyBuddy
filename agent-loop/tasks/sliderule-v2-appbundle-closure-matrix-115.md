...
- [ ] List every required ref family that AppBundle must close.
- [ ] Represent closure checks in a deterministic matrix-like structure.
- [ ] Add tests for a valid purchase app closure matrix.
