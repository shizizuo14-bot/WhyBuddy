# SlideRule V2 Cross-Skill Runtime 118: AIGC 022 cross-skill fixture to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-aigc-022-cross-skill-fixture-to-datamodel-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes aigc -> datamodel linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-aigc-022-cross-skill-fixture-to-datamodel-118.md`
