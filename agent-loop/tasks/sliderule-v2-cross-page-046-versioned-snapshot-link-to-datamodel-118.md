# SlideRule V2 Cross-Skill Runtime 118: Page 046 versioned snapshot link to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-page-046-versioned-snapshot-link-to-datamodel-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-046-versioned-snapshot-link-to-datamodel-118.md`
