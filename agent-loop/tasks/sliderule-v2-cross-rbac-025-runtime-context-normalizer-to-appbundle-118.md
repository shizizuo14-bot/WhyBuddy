# SlideRule V2 Cross-Skill Runtime 118: RBAC 025 runtime context normalizer to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-025-runtime-context-normalizer-to-appbundle-118.md`
...
- [ ] Reuse or extend `evaluateRbacRuntimePolicy` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes rbac -> appbundle linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-025-runtime-context-normalizer-to-appbundle-118.md`
