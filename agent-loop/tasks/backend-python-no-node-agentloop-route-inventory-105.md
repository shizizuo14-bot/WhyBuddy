# Backend Python No-Node API 105: Inventory Node AgentLoop API routes, workbench data, run details, and queue controls.

## Execution status
- Status: pending
- Goal: Inventory Node AgentLoop API routes, workbench data, run details, and queue controls.
...
- `agent-loop/tasks/backend-python-no-node-agentloop-route-inventory-105.md`
- Node side: `server/routes/agent-loop.ts, agent-loop/**, client/src/**`
...
- Current task file: `agent-loop/tasks/backend-python-no-node-agentloop-route-inventory-105.md`
