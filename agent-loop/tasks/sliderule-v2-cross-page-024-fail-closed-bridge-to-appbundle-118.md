# SlideRule V2 Cross-Skill Runtime 118: Page 024 fail-closed bridge to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-page-024-fail-closed-bridge-to-appbundle-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-024-fail-closed-bridge-to-appbundle-118.md`
