# SlideRule V2 Cross-Skill Runtime 118: RBAC 013 closure graph edge to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-013-closure-edge-to-datamodel-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes rbac -> datamodel linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-013-closure-edge-to-datamodel-118.md`
