# Backend Python 105: Task event append persistence takeover

## Execution status
- Status: pending
- Goal: Make Python own task event append/replay persistence instead of only replay projection.
...
- `agent-loop/tasks/backend-python-task-event-append-store-takeover-105.md`
...
- Previous 105 queue tasks 1-11 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Implement Python event append persistence with replay cursor.
2. Bridge Node event APIs to Python append/replay.
3. Test append ordering, replay, duplicate id, and error cases.
