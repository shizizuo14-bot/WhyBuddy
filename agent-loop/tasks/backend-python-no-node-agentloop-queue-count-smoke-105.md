# Backend Python No-Node API 105: Add a smoke guard for queue count consistency such as 48 versus 56 task drift.

## Execution status
- Status: pending
- Goal: Add a smoke guard for queue count consistency such as 48 versus 56 task drift.
...
- `agent-loop/tasks/backend-python-no-node-agentloop-queue-count-smoke-105.md`
- Node side: `scripts/**, server/routes/agent-loop.ts, client/src/**`
...
- Current task file: `agent-loop/tasks/backend-python-no-node-agentloop-queue-count-smoke-105.md`
