# SlideRule V2 Cross-Skill Runtime 118: Workflow 072 cross-skill fixture to appbundle

## Execution status
- Status: PENDING
- Phase: 118-cross-skill-runtime
- Skill: workflow
- Target skill: appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-072-cross-skill-fixture-to-appbundle-118.md`
...
- [ ] Reuse or extend `buildWorkflowFormRuntime` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes workflow -> appbundle linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-072-cross-skill-fixture-to-appbundle-118.md`
