# SlideRule V2 Cross-Skill Runtime 118: DataModel 077 impact projection to page
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-077-impact-projection-to-page-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-077-impact-projection-to-page-118.md`
