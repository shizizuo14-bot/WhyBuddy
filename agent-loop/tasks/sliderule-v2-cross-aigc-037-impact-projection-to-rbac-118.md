# SlideRule V2 Cross-Skill Runtime 118: AIGC 037 impact projection to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-aigc-037-impact-projection-to-rbac-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-aigc-037-impact-projection-to-rbac-118.md`
