# SlideRule V2 Cross-Skill Runtime 118: Workflow 078 audit trace evidence to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-078-audit-trace-to-datamodel-118.md`
...
- [ ] Thread traceSpan/traceId style audit metadata through the source-to-target runtime output.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-078-audit-trace-to-datamodel-118.md`
