# SlideRule Python V5.2 Full Authority 105: Add tests proving PUT sanitization recomputes coverage from server ledger only.

## Execution status
- Status: pending
- Goal: Add tests proving PUT sanitization recomputes coverage from server ledger only.
...
- Current task file: `agent-loop/tasks/sliderule-python-v52-gcov-put-boundary-tests-105.md`
