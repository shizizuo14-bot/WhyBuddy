# SlideRule V2 Cross-Skill Runtime 118: Workflow 019 negative runtime path to page
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-019-sample-negative-path-to-page-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-019-sample-negative-path-to-page-118.md`
