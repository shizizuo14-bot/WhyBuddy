# SlideRule V2 Cross-Skill Runtime 118: DataModel 063 closure graph edge to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-063-closure-edge-to-workflow-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes datamodel -> workflow linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-063-closure-edge-to-workflow-118.md`
