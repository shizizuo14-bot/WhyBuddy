# SlideRule V2 Cross-Skill Runtime 118: RBAC 010 positive runtime path to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-010-sample-positive-path-to-appbundle-118.md`
...
- [ ] Reuse or extend `evaluateRbacFieldAccess` where it is the nearest existing runtime primitive.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-010-sample-positive-path-to-appbundle-118.md`
