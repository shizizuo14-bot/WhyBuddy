# SlideRule V2 Cross-Skill Runtime 118: Page 011 runtime evidence adapter to workflow
...
- `agent-loop/tasks/sliderule-v2-cross-page-011-runtime-evidence-adapter-to-workflow-118.md`
...
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes page -> workflow linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-011-runtime-evidence-adapter-to-workflow-118.md`
