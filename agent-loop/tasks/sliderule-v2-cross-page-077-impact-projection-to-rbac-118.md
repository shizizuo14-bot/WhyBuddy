# SlideRule V2 Cross-Skill Runtime 118: Page 077 impact projection to rbac
...
- `agent-loop/tasks/sliderule-v2-cross-page-077-impact-projection-to-rbac-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-077-impact-projection-to-rbac-118.md`
