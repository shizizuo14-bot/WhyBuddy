# SlideRule V2 Cross-Skill Runtime 118: Page 016 versioned snapshot link to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-page-016-versioned-snapshot-link-to-appbundle-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-016-versioned-snapshot-link-to-appbundle-118.md`
