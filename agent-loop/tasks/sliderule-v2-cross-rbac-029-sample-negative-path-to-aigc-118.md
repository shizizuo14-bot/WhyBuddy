# SlideRule V2 Cross-Skill Runtime 118: RBAC 029 negative runtime path to aigc
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-029-sample-negative-path-to-aigc-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-029-sample-negative-path-to-aigc-118.md`
