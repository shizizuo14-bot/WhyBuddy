...
- [ ] Represent impacted nodes, paths, depth, and via labels consistently.
- [ ] Keep impact graph projection deterministic for snapshots and docs.
- [ ] Add tests for at least one multi-hop role impact and one multi-hop field impact.
