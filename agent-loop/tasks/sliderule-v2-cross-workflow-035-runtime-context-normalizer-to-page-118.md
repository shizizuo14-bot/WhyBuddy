# SlideRule V2 Cross-Skill Runtime 118: Workflow 035 runtime context normalizer to page
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-035-runtime-context-normalizer-to-page-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-035-runtime-context-normalizer-to-page-118.md`
