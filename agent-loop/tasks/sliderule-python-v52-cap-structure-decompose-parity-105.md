# SlideRule Python V5.2 Full Authority 105: Port structure.decompose including schema and invariant gates.

## Execution status
- Status: pending
- Goal: Port structure.decompose including schema and invariant gates.
...
- Current task file: `agent-loop/tasks/sliderule-python-v52-cap-structure-decompose-parity-105.md`
