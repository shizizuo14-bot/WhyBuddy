# SlideRule V2 Cross-Skill Runtime 118: Workflow 008 audit trace evidence to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-008-audit-trace-to-appbundle-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-008-audit-trace-to-appbundle-118.md`
