# sliderule-v2-closure-python-01-python-drive-full-skill-runtime-graph-schema-119
...
## Objective
Add Python schema for skillRuntimeGraph compatible with the TypeScript crossRuntimeGraph shape.
