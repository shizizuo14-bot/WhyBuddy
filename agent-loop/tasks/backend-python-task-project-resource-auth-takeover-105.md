# Backend Python 105: Task project resource auth takeover

## Execution status
- Status: pending
- Goal: Make Python own project/resource authorization decisions for task lifecycle routes.
...
- `agent-loop/tasks/backend-python-task-project-resource-auth-takeover-105.md`
...
- Previous 105 queue tasks 1-13 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Implement Python project/resource auth enforcement envelope.
2. Replace Node-only enforcement with Python-first check and Node compatibility fallback.
3. Test allow, deny, missing project, stale token, and audit metadata.
