# SlideRule V2 Cross-Skill Runtime 118: RBAC 015 runtime context normalizer to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-015-runtime-context-normalizer-to-appbundle-118.md`
...
- [ ] Reuse or extend `evaluateRbacRowAccess` where it is the nearest existing runtime primitive.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-015-runtime-context-normalizer-to-appbundle-118.md`
