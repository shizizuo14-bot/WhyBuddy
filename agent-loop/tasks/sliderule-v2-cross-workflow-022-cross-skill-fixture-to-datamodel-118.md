# SlideRule V2 Cross-Skill Runtime 118: Workflow 022 cross-skill fixture to datamodel
...
- `agent-loop/tasks/sliderule-v2-cross-workflow-022-cross-skill-fixture-to-datamodel-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-workflow-022-cross-skill-fixture-to-datamodel-118.md`
