# SlideRule V2 Cross-Skill Runtime 118: AppBundle 079 negative runtime path to page
...
- `agent-loop/tasks/sliderule-v2-cross-appbundle-079-sample-negative-path-to-page-118.md`
...
- [ ] Add a negative path helper or sample showing the target skill fails closed when source evidence is invalid.
- [ ] Reuse or extend `evaluateAppBundleRuntimeClosure` where it is the nearest existing runtime primitive.
- [ ] Add a stable exported symbol, type, helper, evidence key, fixture, or orchestrator projection that makes appbundle -> page linkage more executable.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-appbundle-079-sample-negative-path-to-page-118.md`
