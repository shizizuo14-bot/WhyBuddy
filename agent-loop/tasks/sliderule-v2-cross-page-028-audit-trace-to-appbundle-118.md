# SlideRule V2 Cross-Skill Runtime 118: Page 028 audit trace evidence to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-page-028-audit-trace-to-appbundle-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-page-028-audit-trace-to-appbundle-118.md`
