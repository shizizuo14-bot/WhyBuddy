# SlideRule V2 Cross-Skill Runtime 118: DataModel 020 positive runtime path to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-020-sample-positive-path-to-appbundle-118.md`
...
- [ ] Add a positive path helper or sample showing the target skill accepts source runtime evidence.
- [ ] Reuse or extend `resolveDatasetBindingRuntime` where it is the nearest existing runtime primitive.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-020-sample-positive-path-to-appbundle-118.md`
