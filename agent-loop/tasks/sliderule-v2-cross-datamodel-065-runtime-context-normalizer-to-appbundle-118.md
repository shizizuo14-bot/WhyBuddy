# SlideRule V2 Cross-Skill Runtime 118: DataModel 065 runtime context normalizer to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-datamodel-065-runtime-context-normalizer-to-appbundle-118.md`
...
- [ ] Reuse or extend `buildFieldLineageIndex` where it is the nearest existing runtime primitive.
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-datamodel-065-runtime-context-normalizer-to-appbundle-118.md`
