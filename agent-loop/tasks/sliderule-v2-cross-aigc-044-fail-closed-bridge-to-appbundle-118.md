# SlideRule V2 Cross-Skill Runtime 118: AIGC 044 fail-closed bridge to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-aigc-044-fail-closed-bridge-to-appbundle-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-aigc-044-fail-closed-bridge-to-appbundle-118.md`
