# SlideRule V2 Cross-Skill Runtime 118: RBAC 055 runtime context normalizer to appbundle
...
- `agent-loop/tasks/sliderule-v2-cross-rbac-055-runtime-context-normalizer-to-appbundle-118.md`
...
## Required validation
- `node agent-loop/src/check-mojibake.js agent-loop/tasks/sliderule-v2-cross-rbac-055-runtime-context-normalizer-to-appbundle-118.md`
