# Backend Python 105: Audit retention export anomaly takeover

## Execution status
- Status: pending
- Goal: Move retention, export, anomaly, and compliance workflows to Python-owned runtime.
...
- `agent-loop/tasks/backend-python-audit-retention-export-anomaly-takeover-105.md`
...
- Previous 105 queue tasks 1-24 when their outputs are relevant.
- Existing Python and Node tests near the files listed above

## Required implementation
1. Implement Python retention/export/anomaly/compliance decisions.
2. Delegate Node audit routes to Python-first runtime.
3. Test retention policies, archive/export, anomaly result, and compliance failure states.
