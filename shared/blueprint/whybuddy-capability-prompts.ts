 ...
 *
 * server/routes/whybuddy.ts 与未来 browser-llm provider 消费同一套 prompt 构造逻辑。
 * 避免执行器路径分裂。
 *
 * 本模块纯函数：
 * - 不读 env
...
import { buildStructuredReport } from "./whybuddy-report-builder.js";
import {
  buildCapabilityContext,
  formatContextForPrompt,
  classifyCapabilityTier,
} from "./whybuddy-capability-context.js";
import {
  getOutputContract,
  renderContractForPrompt,
  renderContractSchema,
} from "./whybuddy-output-contracts.js";
import { capabilityDomainAnchoringBlock } from "./whybuddy-narration-immunity.js";
