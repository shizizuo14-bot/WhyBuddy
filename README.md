...
These examples come from the [WhyBuddyExample](./docs/assets/WhyBuddyExample/) directory, covering 12 scenarios and 38 interface mockups.

<table aria-label="WhyBuddy example photo wall">
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/创作者选题管理系统/创作者选题管理系统screen_n0_创作者选题管理闭环.png" alt="创作者选题管理系统 · 创作者选题管理闭环" />
      <br/>
      <sub>创作者选题管理系统 · 创作者选题管理闭环</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/创作者选题管理系统/创作者选题管理系统screen_n1_选题采集与知识归档.png" alt="创作者选题管理系统 · 选题采集与知识归档" />
      <br/>
      <sub>创作者选题管理系统 · 选题采集与知识归档</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/低代码表单生成器/低代码表单生成器screen_n0_表单资产与模板工作台.png" alt="低代码表单生成器 · 表单资产与模板工作台" />
      <br/>
      <sub>低代码表单生成器 · 表单资产与模板工作台</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/低代码表单生成器/低代码表单生成器screen_n1_可视化表单搭建器.png" alt="低代码表单生成器 · 可视化表单搭建器" />
      <br/>
      <sub>低代码表单生成器 · 可视化表单搭建器</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/低代码表单生成器/低代码表单生成器screen_n2_预览发布与填写体验.png" alt="低代码表单生成器 · 预览发布与填写体验" />
      <br/>
      <sub>低代码表单生成器 · 预览发布与填写体验</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/独立开发者收入看板/独立开发者收入看板screen_n0_收入总览与经营目标可视化.png" alt="独立开发者收入看板 · 收入总览与经营目标可视化" />
      <br/>
      <sub>独立开发者收入看板 · 收入总览与经营目标可视化</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/独立开发者收入看板/独立开发者收入看板screen_n1_多渠道接入与补录.png" alt="独立开发者收入看板 · 多渠道接入与补录" />
      <br/>
      <sub>独立开发者收入看板 · 多渠道接入与补录</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/独立开发者收入看板/独立开发者收入看板screen_n2_评估打分与立项决策.png" alt="独立开发者收入看板 · 评估打分与立项决策" />
      <br/>
      <sub>独立开发者收入看板 · 评估打分与立项决策</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/独立开发者收入看板/独立开发者收入看板screen_n2_收入分析与异常识别.png" alt="独立开发者收入看板 · 收入分析与异常识别" />
      <br/>
      <sub>独立开发者收入看板 · 收入分析与异常识别</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/内容发布排期工具/内容发布排期工具screen_n0_内容发布排期工具.png" alt="内容发布排期工具 · 内容发布排期工具" />
      <br/>
      <sub>内容发布排期工具 · 内容发布排期工具</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/内容发布排期工具/内容发布排期工具screen_n1_日历排期与内容槽位管理.png" alt="内容发布排期工具 · 日历排期与内容槽位管理" />
      <br/>
      <sub>内容发布排期工具 · 日历排期与内容槽位管理</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/内容发布排期工具/内容发布排期工具screen_n2_审批流与自动提醒.png" alt="内容发布排期工具 · 审批流与自动提醒" />
      <br/>
      <sub>内容发布排期工具 · 审批流与自动提醒</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/内容发布排期工具/内容发布排期工具screen_n3_协作看板与状态追踪.png" alt="内容发布排期工具 · 协作看板与状态追踪" />
      <br/>
      <sub>内容发布排期工具 · 协作看板与状态追踪</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/轻量 CRM 客户跟进系统/轻量 CRM 客户跟进系统screen_n0_提供客户与跟进的日常闭环工作台.png" alt="轻量 CRM 客户跟进系统 · 提供客户与跟进的日常闭环工作台" />
      <br/>
      <sub>轻量 CRM 客户跟进系统 · 提供客户与跟进的日常闭环工作台</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/轻量 CRM 客户跟进系统/轻量 CRM 客户跟进系统screen_n1_支持快速创建与维护客户档案.png" alt="轻量 CRM 客户跟进系统 · 支持快速创建与维护客户档案" />
      <br/>
      <sub>轻量 CRM 客户跟进系统 · 支持快速创建与维护客户档案</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/轻量 CRM 客户跟进系统/轻量 CRM 客户跟进系统screen_n2_支持查看完整跟进历史与下次跟进计划.png" alt="轻量 CRM 客户跟进系统 · 支持查看完整跟进历史与下次跟进计划" />
      <br/>
      <sub>轻量 CRM 客户跟进系统 · 支持查看完整跟进历史与下次跟进计划</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/轻量 CRM 客户跟进系统/轻量 CRM 客户跟进系统screen_n3_支持按条件搜索和筛选客户.png" alt="轻量 CRM 客户跟进系统 · 支持按条件搜索和筛选客户" />
      <br/>
      <sub>轻量 CRM 客户跟进系统 · 支持按条件搜索和筛选客户</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/投资研究 Agent项目/投资研究 Agent项目screen_n0_建立_A_股个股研究主流程模板.png" alt="投资研究 Agent项目 · 建立 A 股个股研究主流程模板" />
      <br/>
      <sub>投资研究 Agent项目 · 建立 A 股个股研究主流程模板</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/投资研究 Agent项目/投资研究 Agent项目screen_n1_嵌入合规与风险披露结构.png" alt="投资研究 Agent项目 · 嵌入合规与风险披露结构" />
      <br/>
      <sub>投资研究 Agent项目 · 嵌入合规与风险披露结构</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/小团队 OKR 管理系统/小团队 OKR 管理系统screen_n0_团队与周期初始化.png" alt="小团队 OKR 管理系统 · 团队与周期初始化" />
      <br/>
      <sub>小团队 OKR 管理系统 · 团队与周期初始化</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/小团队 OKR 管理系统/小团队 OKR 管理系统screen_n1_OKR_创建与目标对齐.png" alt="小团队 OKR 管理系统 · OKR 创建与目标对齐" />
      <br/>
      <sub>小团队 OKR 管理系统 · OKR 创建与目标对齐</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/小团队 OKR 管理系统/小团队 OKR 管理系统screen_n2_进展更新与评分复盘.png" alt="小团队 OKR 管理系统 · 进展更新与评分复盘" />
      <br/>
      <sub>小团队 OKR 管理系统 · 进展更新与评分复盘</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/舆情分析项目/舆情分析项目screen_n0_统一舆情监测总览.png" alt="舆情分析项目 · 统一舆情监测总览" />
      <br/>
      <sub>舆情分析项目 · 统一舆情监测总览</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/舆情分析项目/舆情分析项目screen_n1_异常波动预警与处置.png" alt="舆情分析项目 · 异常波动预警与处置" />
      <br/>
      <sub>舆情分析项目 · 异常波动预警与处置</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/舆情分析项目/舆情分析项目screen_n2_事件分析与报告输出.png" alt="舆情分析项目 · 事件分析与报告输出" />
      <br/>
      <sub>舆情分析项目 · 事件分析与报告输出</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/舆情分析项目/舆情分析项目screen_n3_管理配置与审计留痕.png" alt="舆情分析项目 · 管理配置与审计留痕" />
      <br/>
      <sub>舆情分析项目 · 管理配置与审计留痕</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/自动竞品分析/自动竞品分析screen_n0_自动竞品分析平台总目标.png" alt="自动竞品分析 · 自动竞品分析平台总目标" />
      <br/>
      <sub>自动竞品分析 · 自动竞品分析平台总目标</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/自动竞品分析/自动竞品分析screen_n1_多源竞品画像采集与归一化.png" alt="自动竞品分析 · 多源竞品画像采集与归一化" />
      <br/>
      <sub>自动竞品分析 · 多源竞品画像采集与归一化</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/AI 简历优化平台/AI 简历优化平台screen_n0_AI_简历优化主闭环 (1).png" alt="AI 简历优化平台 · AI 简历优化主闭环 (1)" />
      <br/>
      <sub>AI 简历优化平台 · AI 简历优化主闭环 (1)</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/AI 简历优化平台/AI 简历优化平台screen_n0_AI_简历优化主闭环.png" alt="AI 简历优化平台 · AI 简历优化主闭环" />
      <br/>
      <sub>AI 简历优化平台 · AI 简历优化主闭环</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/AI 简历优化平台/AI 简历优化平台screen_n1_简历解析与结构化诊断.png" alt="AI 简历优化平台 · 简历解析与结构化诊断" />
      <br/>
      <sub>AI 简历优化平台 · 简历解析与结构化诊断</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/AI PRD 生成 Agent项目/AI PRD 生成 Agent项目design.png" alt="AI PRD 生成 Agent项目 · design" />
      <br/>
      <sub>AI PRD 生成 Agent项目 · design</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/AI PRD 生成 Agent项目/AI PRD 生成 Agent项目requirements.png" alt="AI PRD 生成 Agent项目 · requirements" />
      <br/>
      <sub>AI PRD 生成 Agent项目 · requirements</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/AI PRD 生成 Agent项目/AI PRD 生成 Agent项目screen_n0_一句话想法接入与需求成形.png" alt="AI PRD 生成 Agent项目 · 一句话想法接入与需求成形" />
      <br/>
      <sub>AI PRD 生成 Agent项目 · 一句话想法接入与需求成形</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/AI PRD 生成 Agent项目/AI PRD 生成 Agent项目screen_n1_标准_PRD_自动生AI PRD 生成 Agent项目成.png" alt="AI PRD 生成 Agent项目 · 标准 PRD 自动生AI PRD 生成 Agent项目成" />
      <br/>
      <sub>AI PRD 生成 Agent项目 · 标准 PRD 自动生AI PRD 生成 Agent项目成</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/AI PRD 生成 Agent项目/AI PRD 生成 Agent项目screen_n2_Web_内编辑与导出评审.png" alt="AI PRD 生成 Agent项目 · Web 内编辑与导出评审" />
      <br/>
      <sub>AI PRD 生成 Agent项目 · Web 内编辑与导出评审</sub>
    </td>
  </tr>
  <tr>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/GitHub Issue 自动分诊 Agent/GitHub Issue 自动分诊 Agentscreen_n0_GitHub_Issue_事件触发的建议式分诊主.png" alt="GitHub Issue 自动分诊 Agent · GitHub Issue 事件触发的建议式分诊主" />
      <br/>
      <sub>GitHub Issue 自动分诊 Agent · GitHub Issue 事件触发的建议式分诊主</sub>
    </td>
    <td width="33%" valign="top">
      <img src="./docs/assets/WhyBuddyExample/GitHub Issue 自动分诊 Agent/GitHub Issue 自动分诊 Agentscreen_n1_建议结果必须附带解释与置信度.png" alt="GitHub Issue 自动分诊 Agent · 建议结果必须附带解释与置信度" />
      <br/>
      <sub>GitHub Issue 自动分诊 Agent · 建议结果必须附带解释与置信度</sub>
    </td>
    <td width="33%"></td>
  </tr>
</table>
