...
- [x] 1. 新增 `derive-spec-tree-chip.ts` 与单测
...
- [x] 2. 新增 `parse-spec-docs-observing.ts` 与单测
...
- [x] 3. 新增 `SpecTreeChip` 与 `SpecDocPreviewBlock` 子组件
  - 路径：
...
- [x] 9. 在 `AutopilotRoutePage` 派生 specDocuments
...
- [x] 10. 更新 `useAutoAdvance` 跳过 spec_documents
