...
Spec folder: `.kiro/specs/sliderule-3d-real-role-driven-scene-2026-05-29`
...
- [x] 4. Add the non-canvas DOM marker in `Scene3D.tsx`
  ...
  - Render `<div data-testid="sliderule-3d-shell" data-mode={mode} />` adjacent to the `<Canvas>`, after `</Canvas>` or another non-canvas sibling position.
...
- [x] 17. Add DEV scene bridge
  ...
  - Add `window.__sliderule3dScene` in DEV only.
