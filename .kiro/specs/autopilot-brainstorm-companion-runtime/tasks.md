...
- [x] 1. Pool-backed brainstorm llmCaller
...
- [x] 3. Session→BrainstormReasoningGraph 投影
...
- [x] 4. 编排注入：辩论用 pool caller、综合/审计用主 caller
