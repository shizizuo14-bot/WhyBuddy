...
- [x] 7. 联调点击路径与任务焦点同步
  ...
  - [x] 7.5 确保 `/tasks`、任务详情、终端详情、截图放大路径不回归

- [x] 8. 完成桌面视觉回归与手测留痕
  - [x] 8.1 验证默认桌面镜头下 2 秒内可读出任务状态和进度
  - [x] 8.2 验证中间区明显强于左右两区
  - [x] 8.3 验证无任务、等待中、运行中、失败、完成五类状态
  - [x] 8.4 验证与底部 `OfficeTaskCockpit` 共存时主次关系稳定
  - [x] 8.5 记录 v1 与 v2 的差异点，补充回归留痕
