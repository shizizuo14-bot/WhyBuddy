...
Agent Marketplace Platform 是 SlideRule 平台的开放 Agent 交易市场模块。第三方开发者可以开发、发布和销售自定义 Agent，平台用户可以浏览、评价、购买或订阅 Agent，并将其集成到自己的工作流中。系统支持 Agent 的版本管理、依赖管理、安全审核、收益分配、用户评价等完整的生态运营功能，形成开发者、平台、用户三方共赢的生态飞轮。
