...
#### 验收标准
- AC-3.1: IndexedDB 数据库名 `sliderule-runtime`，包含 meta/aiConfig/agents/souls/heartbeats/workflows/workflowDetails/recentMemory/memorySearch/heartbeatStatuses/heartbeatReports 等 store
