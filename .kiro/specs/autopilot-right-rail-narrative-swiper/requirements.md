...
本规格用于把 SlideRule Autopilot 主壳右栏底部的“流式日志输出”从“黑白控制台框”升级为“阶段化叙事卡片流”。
...
**User Story:** 作为 SlideRule 的演示者与日常用户，我想要让右栏底部叙事卡片在不同阶段呈现不同的视觉语境，以便于一眼判断“现在系统在做哪一件事”，而不是看一堆雷同的黑白控制台框。
