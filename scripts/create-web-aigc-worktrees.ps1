...
$worktrees = @(
  @{ Branch = "chore/web-aigc-main-control"; Path = "..\sliderule-web-aigc-0-main-control" },
  @{ Branch = "feat/web-aigc-platform-a"; Path = "..\sliderule-web-aigc-1-platform-a" },
  @{ Branch = "feat/web-aigc-platform-b"; Path = "..\sliderule-web-aigc-2-platform-b" },
  @{ Branch = "feat/web-aigc-platform-c"; Path = "..\sliderule-web-aigc-3-platform-c" },
  @{ Branch = "feat/web-aigc-dialogue-qa"; Path = "..\sliderule-web-aigc-4-dialogue-qa" },
  @{ Branch = "feat/web-aigc-hitl-session"; Path = "..\sliderule-web-aigc-5-hitl-session" },
  @{ Branch = "feat/web-aigc-content-processing"; Path = "..\sliderule-web-aigc-6-content-processing" },
  @{ Branch = "feat/web-aigc-multimodal-output"; Path = "..\sliderule-web-aigc-7-multimodal-output" },
  @{ Branch = "feat/web-aigc-tools-and-agents"; Path = "..\sliderule-web-aigc-8-tools-and-agents" },
  @{ Branch = "feat/web-aigc-controlflow"; Path = "..\sliderule-web-aigc-9-controlflow" },
  @{ Branch = "feat/web-aigc-risk-actions"; Path = "..\sliderule-web-aigc-10-risk-actions" }
)
