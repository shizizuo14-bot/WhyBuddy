/**
 * SlideRule V5.1 Full-Path Acceptance Test Plan — Batch 3b: negative invariants (N series).
 ...
 * double-保险: a STATIC source grep (read sliderule-runtime.ts / SlideRule.tsx via node:fs) PLUS a
...
class TinySessionStore implements SlideRuleSessionStore {
