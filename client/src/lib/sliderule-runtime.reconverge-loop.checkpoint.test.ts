/**
 * Checkpoint Coverage — SlideRule V5.1 Reconverge Loop Fix
 * Spec: .kiro/specs/sliderule-reconverge-loop-fix/ (Task 4, design "Testing Strategy")
 *
 ...
 *   3. Full CLOSED-LOOP re-convergence — drive `/sliderule` runtime to `goal.status === "clear"`,
