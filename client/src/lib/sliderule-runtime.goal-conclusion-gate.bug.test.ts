/**
 * Bug Condition Exploration Test — SlideRule V5.1 GOAL Conclusion Gate
 * Spec: .kiro/specs/sliderule-goal-conclusion-gate/ (Task 1, Property 1: Bug Condition)
 *
...
// ---- helpers (mirror conventions from sliderule-runtime.test.ts) ----
...
describe('SlideRule GCOV-pass writes goal.status when G-GROUND satisfied (Property 1)', () => {
