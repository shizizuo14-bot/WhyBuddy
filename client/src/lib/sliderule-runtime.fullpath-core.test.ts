/**
 * SlideRule V5.1 Full-Path Acceptance Test Plan — Batch 1: core control plane + trust spine.
 ...
 * sliderule-runtime.fullpath-status.test.tsx (renderToStaticMarkup, no jsdom).
 */
...
describe('S4 · challenge -> cascade -> reconverge (soul loop second lap, C-1 / C-2)', () => {
  ...
  // RESTORED STRONG ASSERTION (sliderule-stale-set-monotonic has landed). The doc's S4
  ...
  // Tracked by .kiro/specs/sliderule-stale-set-monotonic.
  it(
