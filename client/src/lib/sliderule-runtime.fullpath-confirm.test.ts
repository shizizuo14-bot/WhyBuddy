/**
 * SlideRule V5.1 Full-Path — S12 G_CONFIRM route confirmation chain.
...
import { createRawArtifact, markTrusted } from "./sliderule-fullpath-fixtures";
import { userPicksRoute, userRejectsRouteSelection } from "@shared/blueprint/sliderule-interactive-gates";
