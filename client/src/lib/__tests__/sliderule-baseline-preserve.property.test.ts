...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 20: LLM 能力产物 provenance 为 llm
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 21: 上游依赖正确解析并完整纳入
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 22: LLM 产物不绕过信任闸
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 23: stale 上游被标注
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 24: 报告九段式结构完整
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 30: LLM 路由 DLEDGER 记录完整
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 31: 降级时 DLEDGER 记录来源与原因
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 32: 路由决策可被 challenge 重排程
