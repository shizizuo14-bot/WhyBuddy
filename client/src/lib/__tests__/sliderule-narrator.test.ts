...
import { FALLBACK_BANNED_RE } from "@shared/blueprint/sliderule-deliverable-sanitize";
import { buildFallbackNarration } from "@shared/blueprint/sliderule-deliverable-sanitize";
...
describe("sliderule-narrator local fallback (S6)", () => {
