 ...
 * Feature: sliderule-llm-autonomous-reasoning, Properties 1–9
 */
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 1: 有 gap 且预算充足则自动再入
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 5: 每消息循环上限则停泊 partial
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 8: maxRepeatPerCapability 守卫
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 9: capabilityRun 标识形态兼容
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 3: 每轮独立记录 DLEDGER
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 2: 每次再入前重评 BUDGET 与覆盖率
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 4: 覆盖率充分则停泊
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 7: 连续两轮无进展则停泊
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 10: 单一推演状态真相源
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 6: 新产物下一轮即为上游可见
