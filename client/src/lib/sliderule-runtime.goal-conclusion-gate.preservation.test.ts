/**
 * Preservation Property Tests — SlideRule V5.1 GOAL Conclusion Gate
 * Spec: .kiro/specs/sliderule-goal-conclusion-gate/ (Task 2, Property 2 + Property 3)
 *
...
// ---- helpers (mirror conventions from sliderule-runtime.test.ts / .bug.test.ts) ----
...
// (`sliderule-derive-readonly-guard`). Task 3.3 extracted it there and added a dedicated guard
