/**
 * Bug Condition Exploration Test — WhyBuddy Artifact-Health Predicate Unification
 * Spec: .kiro/specs/whybuddy-artifact-health-predicate/ (Task 1, Property 1: Bug Condition)
 *
 * CRITICAL: These tests are written against UNFIXED code and are EXPECTED TO FAIL.
 * The failure confirms the bug: three call sites in `client/src/lib/whybuddy-runtime.ts`
