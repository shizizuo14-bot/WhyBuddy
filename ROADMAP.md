...
- 目录：`C:\Users\2303670\Documents\sliderule-i18n-mobile`（worktree 已删除）
...
- 目录：`C:\Users\2303670\Documents\sliderule-dynamic-org`（worktree 已删除）
...
- 目录：`C:\Users\2303670\Documents\sliderule-preview-github`（worktree 已删除）
...
- [x] `sliderule` 作为唯一主控 Brain，统一承接 Cube UI 与 Feishu 两个入口。
...
目录：`C:\Users\wangchunji\Documents\sliderule-0-mission-contracts`  
...
目录：`C:\Users\wangchunji\Documents\sliderule-A-mission-core`  
...
目录：`C:\Users\wangchunji\Documents\sliderule-B-lobster-executor`  
...
目录：`C:\Users\wangchunji\Documents\sliderule-C-brain-dispatch`  
...
目录：`C:\Users\wangchunji\Documents\sliderule-D-feishu-mission-bridge`  
...
目录：`C:\Users\wangchunji\Documents\sliderule-E-tasks-universe`  
...
目录：`C:\Users\wangchunji\Documents\sliderule-F-mission-integration`  
...
- [ ] `sliderule` 已具备 Brain + Docker 执行 + Feishu 回传 + 任务宇宙可视化的首版闭环。
...
6. **MySQL 远程连接注意事项**：
   ...
   - 确保 root 账户允许远程登录（`GRANT ALL ON sliderule.* TO 'root'@'%'`）
