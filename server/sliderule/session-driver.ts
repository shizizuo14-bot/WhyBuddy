 ...
 * (sliderule-llm-autonomous-reasoning, 需求 1 / 2; task 4.1).
 *
 * The multi-step re-entry loop CORE lives once in the runtime
 * (`client/src/lib/sliderule-runtime.ts` → `driveReasoningSession`). This module
 ...
 * (`server/sliderule/deterministic-provider.ts`).
 *
...
} from "../../client/src/lib/sliderule-runtime";
