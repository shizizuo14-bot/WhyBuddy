/**
 * sliderule-llm-autonomous-reasoning — LLM_Router property tests (tasks 2.5–2.10).
...
} from "../sliderule/orchestrate-plan.js";
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 11: 路由模型解析与回退
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 12: 覆盖率摘要注入路由 prompt
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 13: 收敛信号机械判定
...
/**
 * Feature: sliderule-llm-autonomous-reasoning, Property 29: 路由摘要不含完整 content
