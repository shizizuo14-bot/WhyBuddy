...
- Optionally modify: `docs/sliderule-toc-login-architecture-2026-04-30.svg`
...
```powershell
git add .kiro/specs/consumer-email-auth-and-account/tasks.md .kiro/specs/personal-project-ownership-and-isolation/tasks.md .kiro/specs/admin-console-and-global-role-gate/tasks.md docs/toc-auth-project-admin-spec-progress-overview-2026-04-30.svg docs/sliderule-toc-login-architecture-2026-04-30.svg
...
```text
MYSQL_OK database=sliderule applied=0 skippedSecond=1
...
```text
MYSQL_OK database=sliderule applied=1 skippedSecond=2
REDIS_OK db=2 prefix=cube:pets:office:
```
