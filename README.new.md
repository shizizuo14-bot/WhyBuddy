<p align="center">
  <img src="./docs/assets/banner.png" alt="SlideRule banner" width="100%" />
</p>

<h1 align="center"><img src="./docs/assets/logo.png" alt="SlideRule" height="44" align="absmiddle" />&nbsp;&nbsp;|&nbsp;&nbsp;SlideRule</h1>
...
<p align="center">
  ...
  <img alt="stars" src="https://img.shields.io/github/stars/opencroc/sliderule?style=flat" />
...
<p align="center">
  <a href="https://opencroc.github.io/sliderule/">在线演示</a> •
  <a href="./docs/">文档</a> •
...
访问 [在线演示](https://opencroc.github.io/sliderule/) 或本地运行：

```bash
# 三条命令启动
git clone https://github.com/opencroc/sliderule.git && cd sliderule
pnpm install
...
<table>
  <tr>
    <td width="50%"><img src="./docs/assets/A.png" alt="SlideRule 界面截图 A" /></td>
    <td width="50%"><img src="./docs/assets/B.png" alt="SlideRule 界面截图 B" /></td>
  </tr>
  <tr>
    <td width="50%"><img src="./docs/assets/C.png" alt="SlideRule 界面截图 C" /></td>
    <td width="50%"><img src="./docs/assets/D.png" alt="SlideRule 界面截图 D" /></td>
  </tr>
    <tr>
    <td width="50%"><img src="./docs/assets/E.png" alt="SlideRule 界面截图 E" /></td>
    <td width="50%"><img src="./docs/assets/F.png" alt="SlideRule 界面截图 F" /></td>
  </tr>
</table>
...
SlideRule 是一个开源的 **AI 产品预演引擎**。输入一句话想法，它为你推演出完整的产品方案 —— 规格文档、系统架构、路线规划、提示词包、效果预览 —— 全程可见、全部可导出、全部有证据留痕。
...
SlideRule 跳过等待。输入你的想法，让 FSD 车队在 5 分钟内完成预演，在投入任何工程资源之前看到全貌。

**传统做法**：想法 → 2 周写 PRD → 1 周画架构 → 3 天对齐 → 发现方向不对 → 重来。

**SlideRule**：想法 → 5 分钟 → 完整预演 → 判断值不值得做 → 不值得就换下一个。
...
[![Star History Chart](https://api.star-history.com/svg?repos=opencroc/sliderule&type=Date)](https://star-history.com/#opencroc/sliderule&Date)
